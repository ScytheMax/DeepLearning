...
from Extensions.utils.np_utils import (assert_same_shape,
                       softmax,
                       normalize,
                       #todo exp_ratios,
                       unnormalize)
...
# idea: big deviations has bigger loss as for the mean squared error
#       it implies a bigger gradient and furthermore a faster update process in this case
